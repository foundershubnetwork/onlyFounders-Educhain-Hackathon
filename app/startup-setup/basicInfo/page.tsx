...
const basicInfoSchema = z.object({
  ...
  pitchDeck: z.string().optional().or(z.literal("")),
  demoVideo: z.string().optional().or(z.literal("")),
})
...
export default function BasicInfoForm({ data, updateData, onNext, userId }: BasicInfoFormProps) {
  ...
  const handleSubmit = async (values: BasicInfoValues) => {
    ...
    formData.append("socialLinks", JSON.stringify(socialLinks))
      ...
      if (whitepaperFile) formData.append("whitePaper", whitepaperFile)
      if (pitchDeckFile) formData.append("pitchDeck", pitchDeckFile)    
      if (demoVideoFile) formData.append("pitchDemoVideo", demoVideoFile)
      ...
      toast({
        title: "Success!",
        description: "Your startup information has been submitted successfully.",
      })
              ...
              <div className="flex flex-col items-center mb-4">
                <div className="relative mb-2 w-full">
                  <div className="aspect-[3/1] w-full overflow-hidden rounded-lg border-2 border-gray-800 bg-gray-800">
                    <img src={bannerSrc || "/placeholder.svg"} alt="Banner" className="h-full w-full object-cover" />
                  </div>
                  <label
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <div className="flex-1 bg-gray-800 border border-gray-700 rounded-md overflow-hidden">
                          <div className="flex items-center">
                            <Input
                              readOnly
                              placeholder="Upload whitepaper (PDF)"
                              value={whitepaperName}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="text-white">Pitch Deck</FormLabel>
                    <FormControl>
                      <div className="flex items-center gap-2">
                        <Input
                          type="file"
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="text-white">Demo Video</FormLabel>
                    <FormControl>
                      <div className="flex items-center gap-2">
                        <Input
                          type="file"
                        ...
                        <Button
                          ...
                          variant="outline"
                          className="border-gray-700 text-white"
                          onClick={() => document.getElementById("demovideo-upload")?.click()}
                        >
                          Browse
                        </Button>
                      </div>
