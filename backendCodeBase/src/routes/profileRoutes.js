...
router.get("/get-investors-details",authMiddleware.decodeJWT,profileController.getInvestorDetails);

//done
router.post("/add-walletAddress",authMiddleware.decodeJWT,profileController.addWalletAddress);

router.get("/get-walletconnect-status",authMiddleware.decodeJWT,profileController.isWalletConnected);
