...
import { Hexagon, CheckSquare, Users, TrendingUp, ArrowLeft } from "lucide-react"
  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="The platform where founders come first. And second. And third." />
      </Head>
      ...
      >
        ...
        <Button className="absolute top-10 left-5 flex gap-2 items-center justify-between"><ArrowLeft/> Back to Home </Button>
        </Link>
        {/* Content container */}
        <div className="relative z-10 w-full max-w-4xl mx-auto flex flex-col items-center">
          ...
          <div className="w-full max-w-md bg-[#0a0a32]/80 backdrop-blur-sm rounded-lg p-8 border border-[#1a1a3a] shadow-lg">
            <h2 className="text-2xl font-bold text-center mb-2">Subscribe to Success</h2>
            <p className="text-gray-400 text-center mb-6">No term sheets, just sweet, sweet funding.</p>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="relative">
                <select
                  ...
                  required
                >
                  <option value="" disabled>Founder Type</option>
                  <option value="Founder (Tired of VC BS)">
                    Founder (Tired of VC BS)
                  </option>
                  <option value="Investor (The Cool Kind)">Investor (The Cool Kind)</option>
                </select>
              ...
              {submitStatus.message && (
                <div
                  className={`p-3 rounded-md ${submitStatus.success ? "bg-green-900/50 text-green-200 border border-green-700" : "bg-red-900/50 text-red-200 border border-red-700"}`}
                >
                  {submitStatus.message}
                </div>
              )}
              ...
              <button
                ...
                className={`w-full bg-gradient-to-r from-[#4338ca] to-[#6366f1] hover:from-[#4338ca]/90 hover:to-[#6366f1]/90 text-white font-medium py-2.5 px-4 rounded-md transition-all duration-200 mt-2 ${isSubmitting ? "opacity-70 cursor-not-allowed" : ""}`}
              >
          ...
          <Link href="/" className="block md:hidden mt-10">
            <Button className="flex gap-2 items-center justify-between"><ArrowLeft/> Back to Home </Button>
          </Link>

          {/* Feature Cards */}
          <div className="w-full grid grid-cols-1 md:grid-cols-3 justify-center gap-6 mt-20 px-4">
            {/* Card 1 */}
            <div className="flex-1 basis-[400px] max-w-[500px] bg-[#0a0a32]/80 backdrop-blur-sm rounded-2xl p-8 border border-[#1a1a3a] flex flex-col gap-4 shadow-lg hover:translate-y-[-5px] hover:shadow-xl transition-all duration-200">
              <div className="text-[#4361ee] text-2xl">
                <CheckSquare className="h-6 w-6 stroke-[#4361ee]" />
              </div>
              <h3 className="text-2xl font-bold text-white">No VC, No Problem</h3>
              <p className="text-gray-400 leading-relaxed">
                Skip the awkward coffee meetings. Our AI matches you with investors who won't demand your first-born
                child.
              </p>
            </div>
            ...
            <div className="flex-1 basis-[400px] max-w-[500px] bg-[#0a0a32]/80 backdrop-blur-sm rounded-2xl p-8 border border-[#1a1a3a] flex flex-col gap-4 shadow-lg hover:translate-y-[-5px] hover:shadow-xl transition-all duration-200">
              ...
              <h3 className="text-2xl font-bold text-white">Blockchain & Chill</h3>
              <p className="text-gray-400 leading-relaxed">
                Secure, transparent funding that doesn't require a Stanford degree or a cousin named Chad.
              </p>
            </div>
            ...
            <div className="flex-1 basis-[400px] max-w-[500px] bg-[#0a0a32]/80 backdrop-blur-sm rounded-2xl p-8 border border-[#1a1a3a] flex flex-col gap-4 shadow-lg hover:translate-y-[-5px] hover:shadow-xl transition-all duration-200">
              ...
              <h3 className="text-2xl font-bold text-white">Founder's <br /> Only</h3>
              <p className="text-gray-400 leading-relaxed">
                A platform that treats you like the main character, not just another slide in someone's portfolio.
              </p>
            </div>
          </div>
        </div>
