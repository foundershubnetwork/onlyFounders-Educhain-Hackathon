...
router.post("/view-founder",authMiddleware.decodeJWT,startupController.viewFounder);
...
router.post("/upvote-startup/:id",authMiddleware.decodeJWT,startupController.upvoteStartup);

router.get("/check-startup",authMiddleware.decodeJWT,startupController.checkStartup);

router.get("/get-upvote-count/:id",authMiddleware.decodeJWT,startupController.getUpvoteCount);

router.post("/get-upvote-status/:id",authMiddleware.decodeJWT,startupController.hasUpvoted);
